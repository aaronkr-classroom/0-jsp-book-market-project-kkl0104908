...
<body>
<fmt:setLocale value = '<%=reauest.getParameter("language") %>' />
<fmt:beundle nasename="bundle.message">
<div class = "container py-4">
	...
	<div class = "row align-items-md-stretch">
		...
		-horizontal" method="post" enctype = "multipart/form-data">
			...
			<div class = "mb-3 row">
				<label class = "col-sm-2"><fmt:message key ="untniPrice" /></label>
				<div class="col-sm-3">
					<input type = "text" id = "unitPrice" name = "unitPrice" class="form-control">
				</div>
			</div>
			<div class = "mb-3 row">
				<label class = "col-sm-2"><fmt:message key ="authoer" /></label>
				<div class="col-sm-3">
