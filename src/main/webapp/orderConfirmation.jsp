...
<%
	...
	String shipping shippingDate="";
	String shipping_country = "";
	String shipping_zipCode = "";
	String shipping addressName = "";
	...
	if (cookies!=null) {
		for (int i=0; i < cookies.length; i++) {
			...
			if (n.equals("Shipping_cartId"))
				shipping_cartId=URLDecoder.decode((this Cookie.getValue()), "utf-8");
			if (n.equals("Shipping_name"))
				shipping_name = URLDecoder.decode((thisCookie.getValue()), "utf-8");
			if (n.equals("Shipping shippingDate"))
				shipping shippingDate = URL Decoder.decode((thisCookie.getValue()), "utf-8");
...
<div class="row justify-content-between">
	<div class="col-4" align="left">
		...
		우편번호 : <%out.println(shipping_sipcode);%><br>
		주소 : <%out.println(shipping_addressName);%>(<%out.println(shipping_
		country);%>)<br>
	</div>
	<div class="col-4" align="right">
		<p>배송일:<em> <% out.println(shipping_shippingDate); %></em>
	</div>
</div>
<div class="py-5">
