...
<html>
<head>
<link href = "https://jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel = "stylesheet">
<meta charset="UTF-8">
<title>도서 정보</title>
...
<div class = "container py-4">
	...
	<div class = "p-5 mb-4 bg-body-teritiary rounded-3">
		<div class = "container-fluid py-5">
			<h1 class = "diplay-5 fw-bold">도서정보</h1>
	...
	<div class = "row align-items-md-stretch">
					<div class = "col-md-12">
						...
						<a href = "./book.jsp" class = "btn vtn-secindary"> 도서목록 &raquo;</a>
						</form>
					</div>
	</div>
